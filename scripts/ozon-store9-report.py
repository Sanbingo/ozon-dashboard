...
def main():
    ...
    try:
        ...
        store6_db.init_db('store9')
        store6_db.save_summary('store9', yesterday, analytics_units, analytics_money,
        ...
        store6_db.save_sku_list('store9', yesterday, sorted_skus, campaign_skus, ad_by_campaign, camp_sku_count, sku_ad_expenses)
        store6_db.save_campaigns('store9', yesterday, ad_stats, campaign_names, camp_sku_count)
        log("数据库已保存 ✅")
