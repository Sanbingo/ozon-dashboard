...
LOG_FILE = f"{config.LOG_DIR}/ozon-store10-report.log"

# ===== 常量 =====
PERF_CLIENT_ID = "95727262-1781662661302@advertising.performance.ozon.ru"
PERF_CLIENT_SECRET = "tk6hXTJoTLDPKOGf7Q0xzZ1g6DsxyR-VY31D0dUG75PtgGOkELAN6KotjQadfjRhXYdU8pOJ8ncKWUrqig"
PERF_BASE = "https://api-performance.ozon.ru"
SELLER_CLIENT_ID = str(config.OZON_STORE_KEYS['store10']['client_id'])
SELLER_API_KEY = config.OZON_STORE_KEYS['store10']['api_key']
