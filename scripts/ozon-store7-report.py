...
# ===== 常量 =====
PERF_CLIENT_ID = "95502054-1780975158157@advertising.performance.ozon.ru"
PERF_CLIENT_SECRET = "FFF6Ig2PdrXOl7_ikbLz4G6S-Qc_hYIKZ4gmD4qDRH0gp9buSif_UVPnbE42qU3ua1gXge7LIHXLWpSYww"
PERF_BASE = "https://api-performance.ozon.ru"
SELLER_CLIENT_ID = str(config.OZON_STORE_KEYS['store7']['client_id'])
SELLER_API_KEY = config.OZON_STORE_KEYS['store7']['api_key']
...
def main():
    ...
    try:
        ...
        store6_db.init_db('store7')
        store6_db.save_summary('store7', yesterday, analytics_units, analytics_money,
        ...
        store6_db.save_sku_list('store7', yesterday, sorted_skus, campaign_skus, ad_by_campaign, camp_sku_count, sku_ad_expenses)
        store6_db.save_campaigns('store7', yesterday, ad_stats, campaign_names, camp_sku_count)
        log("数据库已保存 ✅")
